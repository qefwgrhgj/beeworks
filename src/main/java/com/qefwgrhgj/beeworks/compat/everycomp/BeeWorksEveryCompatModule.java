...
public class BeeWorksEveryCompatModule extends SimpleModule {
    ...
    public BeeWorksEveryCompatModule(String modId) {
        ...
        beehives = SimpleEntrySet.builder(WoodType.class, "beehive",
                ...
                .addTag(ResourceLocation.fromNamespaceAndPath("blueprint", "wooden_beehives"), Registries.BLOCK, Registries.ITEM)
                .addTag(ResourceLocation.fromNamespaceAndPath("c", "beehives"), Registries.BLOCK, Registries.ITEM)
